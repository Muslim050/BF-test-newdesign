    ...
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          ...
          <div className="flex gap-4 mb-4">
            <div className='grid w-full'>
              <Label className="text-sm	text-white pb-2">Название компании<span
        ...
        {hasRole('admin') && (
          <div className='flex gap-4 mb-4'>
            <div className='grid w-full'>
              <Label className="text-sm	text-white pb-2">СPM Preroll<span
                className='text-red-500 ml-0.5'>*</span></Label>
              <Input
                type="text"
                autoComplete="off"
                ...
                className={`border ${errors?.cpm_preroll ? 'border-red-500' : 'border-gray-300'}   transition-all duration-300 text-sm `}
              />
              </div>

            <div className='grid w-full'>
              <Label className="text-sm	text-white pb-2">CPM Mixroll<span
                className='text-red-500 ml-0.5'>*</span></Label>
              <Input
                type="text"
                autoComplete="off"
                ...
                className={`border ${errors?.cpm_mixroll ? 'border-red-500' : 'border-gray-300'}   transition-all duration-300 text-sm `}
              />
            </div>
          </div>
        )}
          ...
          {hasRole('admin') && (
            <div className='flex gap-4 mb-4'>
              ...
              <div className='grid w-full'>
                <Label className="text-sm	text-white pb-2">Target preroll<span
                  className='text-red-500 ml-0.5'>*</span></Label>
                <Input
                  type="text"
                  autoComplete="off"
                  ...
                  placeholder={'Введите cpm preroll'}
                  className={`border ${errors?.cpm_preroll_uz ? 'border-red-500' : 'border-gray-300'}   transition-all duration-300 text-sm `}
                />
              </div>

              <div className='grid w-full'>
                <Label className="text-sm	text-white pb-2">Target Mixroll<span
                  className='text-red-500 ml-0.5'>*</span></Label>
                <Input
                  type="text"
                  autoComplete="off"
                  ...
                  className={`border ${
                    errors?.cpm_mixroll_uz ? 'border-red-500' : 'border-gray-300'
          ...
          {/**/}
          <div className='grid'>
            <Label className="text-sm	text-white pb-2">Выбрать рекламное агенство<span
              className='text-red-500 ml-0.5'>*</span></Label>
           <Controller
