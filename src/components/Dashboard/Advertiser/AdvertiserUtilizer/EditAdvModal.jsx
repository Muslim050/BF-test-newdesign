        ...
        <div >
          ...
          <div className="pb-4 flex gap-4">
            ...
            <div className='grid w-full '>
              <Label className="text-sm	text-white pb-1">Preroll
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value, name, ref } }) => (
                  <Input
                    ...
                    autoComplete="off"
                    step="1000"
                    className={`border ${errors?.cpm_preroll ? 'border-red-500' : 'border-gray-300'}  transition-all duration-300 text-sm text-[#CECECE]`}
            ...
            {/**/}
            <div className='grid w-full'>
              <Label className="text-sm	text-white pb-1">Mixroll<span className='text-red-500 ml-0.5'>*</span>
              </Label>
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value, name, ref } }) => (
                  <Input
                    ...
                    autoComplete="off"
                    step="1000"
                    className={`border ${errors?.cpm_mixroll ? 'border-red-500' : 'border-gray-300'}  transition-all duration-300 text-sm text-[#CECECE]`}
          ...
          <div className=" flex gap-4">
            {/**/}
            <div className='grid w-full'>
              <Label className="text-sm	text-white pb-1">Target Preroll<span
              ...
              <Controller
                ...
                render={({field: {onChange, onBlur, value, name, ref}}) => (
                  <Input
                    ...
                    autoComplete="off"
                    step="1000"
                    className={`border ${errors?.cpm_preroll_uz ? 'border-red-500' : 'border-gray-300'}  transition-all duration-300 text-sm text-[#CECECE]`}
            ...
            {/**/}
            <div className='grid w-full'>
              <Label className="text-sm	text-white pb-1">Target Mixroll<span
                className='text-red-500 ml-0.5'>*</span></Label>
              <Controller
                name="cpm_mixroll_uz"
                control={control}
                ...
                render={({field: {onChange, onBlur, value, name, ref}}) => (
                  <Input
                    ...
                    autoComplete="off"
                    step="1000"
                    className={`border ${errors?.cpm_mixroll_uz ? 'border-red-500' : 'border-gray-300'}   transition-all duration-300 text-sm text-[#CECECE]`}
