      ...
      {advertiserAgencyUsers.map((advertiseruser, i) => (
        <>
          <TableBody>
            ...
            <TableCell data-label="Рекламное агентство" className={`font-normal text-${textColor} text-sm `}>
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild className="cursor-pointer">
            ...
            <TableCell data-label="Роль" className={`font-normal text-${textColor} text-sm `}>{advertiseruser.side}</TableCell>
