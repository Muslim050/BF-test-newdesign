          ...
          <div >
            <div className="flex gap-4 mb-4">
              <div className='grid w-full'>
                <Label className="text-sm	text-white pb-1">Название компании<span
                ...
                <Controller
                  ...
                  render={({field: {onChange, onBlur, value, name, ref}}) => (
                    <Input
                      ...
                      ref={ref}
                      autoComplete="off"
                      className={`border ${errors?.name ? 'border-red-500' : 'border-gray-300'} transition-all duration-300 text-sm text-white`}
              ...
              <div className='grid w-full'>
                <Label className="text-sm	text-white pb-1">Номер телефона<span
                  className='text-red-500 ml-0.5'>*</span></Label>
                <Controller
                  name="phone_number"
                  control={control}
                    ...
                    <MaskedInput
                      ...
                      render={(inputRef, props) => (
                        <Input
                          ...
                          className={`border ${errors?.phone_number ? 'border-red-500' : 'border-gray-300'} transition-all duration-300 text-sm `}
                        />
                      )}
                    />
                  )}
            ...
            <div className="flex gap-4">
              <div className='grid w-full'>
                <Label className="text-sm	text-white pb-2 flex gap-0.5">Email<span
              ...
              <div className='grid w-full'>
                <Label className="text-sm	text-white pb-2 flex gap-0.5">Комиссия<span
                  className='text-red-500 ml-0.5'>*</span>
                  <div className="text-sm	text-red-500 "> {errors?.email && <p>{errors.email.message}</p>}
                  </div>
                </Label>
                <Input
                  ...
                  className={`border ${errors?.commission_rate ? 'border-red-500' : 'border-gray-300'}   transition-all duration-300 text-sm `}
                />
              </div>
            </div>
          </div>
