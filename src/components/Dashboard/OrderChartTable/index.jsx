  ...
  return (
    <>
      {loading ? (
        ...
        <div>
          <div
            className="rounded-xl overflow-auto  h-[100%] p-4"
            style={{
              background:
                'linear-gradient(90deg, rgba(255, 255, 255, 0.156) 0%, rgba(255, 255, 255, 0.051) 99.67%)',
            }}
          >
            <div className="flex items-center gap-4 justify-between border-b-[1px] border-[#f9f9f921] pb-3">
              ...
              <div className="flex gap-2">
                ...
                <Popover open={open} onOpenChange={setOpen}>
                  <PopoverTrigger asChild>
                    <Button
                      variant="ghost"
                      className=" px-7 bg-brandPrimary-1 rounded-lg hover:bg-brandPrimary-50 text-white no-underline hover:text-white h-[48px]"
                    >
            ...
            <div>
              ...
              <div
                className={`${style.whitegrad} bg-[#0A0F36] w-full  rounded-xl mt-4 p-3.5`}
              >
                <div className="flex items-center gap-2">
                  <div className="w-2.5	h-6	bg-[#D1C5FF] rounded-[4px]"></div>
                  <h4 className="font-medium text-white">Отчет</h4>
                  <div className="bg-[#ffffff3d] rounded-2xl	p-2">
            ...
            <div className=" rounded-xl p-[3px]  bg-[#0a0f3673] ">
                      ...
                      return (
                        <React.Fragment key={statistic.video_link}>
                          ...
                          {expandedRows === statistic.video_link && (
                            <TableRow
                              key={index}
                              className={`bg-[#ffffff4d]  rounded-lg`}
                            >
                              <DopTable
                                statistic={statistic}
                                data={data}
