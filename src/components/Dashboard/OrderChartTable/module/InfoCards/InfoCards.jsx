...
export function InfoCardsTop({ getOrder }) {
  ...
  return (
    <div className="flex ">
      <div className="text-base h-[90px] gap-5	text-white flex rounded-xl	bg-[#b5e4ca80] items-center px-6	">
        Номер Заказа
        <div className="text-[35px] text-white">{id}</div>
      </div>
      <div className="text-base h-[90px] gap-5	text-white flex rounded-xl	 items-center px-6	">
        План
      ...
      <div className="text-base h-[90px] gap-5	text-white flex rounded-xl	bg-[#2a85ff75] items-center px-6	">
        Бюджет
        <div className="text-[35px] text-white">
          <FormatterBudjet
