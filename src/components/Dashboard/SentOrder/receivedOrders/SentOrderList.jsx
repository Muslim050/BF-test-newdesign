      ...
      {listsentPublisher.map ((item, i) => (
        <>
          <TableRow>
            ...
            <TableCell data-label="Кампания" className={`font-normal text-${textColor} text-sm `}>
              {item.order_name}
            </TableCell>
            ...
            <TableCell data-label="Конец" className={`font-normal text-${textColor} text-sm `}>
              {formatDate (item.end_date)}
            </TableCell>
            <TableCell data-label="Ролик" className={`font-normal text-${textColor} text-sm `}>
              <a
            ...
            <TableCell data-label="План показов" className={`font-normal text-${textColor} text-sm `}>
            ...
            <TableCell data-label="Действия" style={{position: "relative", display: "flex", gap: "10px"}}>
              <button
              ...
              {item.order_status === 'in_progress' || item.order_status === 'finished' ? null :
                <Popover isOpen={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
                  ...
                  {isPopoverOpen && <PopoverContent className="w-[400px] bg-white bg-opacity-30 backdrop-blur-md rounded-xl">
                    <ModalSentOrder setIsPopoverOpen={setIsPopoverOpen} item={item} />
                  </PopoverContent>}
                </Popover>
              }
            </TableCell>
