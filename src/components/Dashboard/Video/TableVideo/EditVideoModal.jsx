          ...
          <div>
            <div className='flex gap-4 mb-4'>
              <div className='grid w-full'>
                <Label className="text-sm	text-white pb-2 flex gap-0.5">Название Видео<span
                  className='text-red-500 ml-0.5'>*</span>
              ...
              <div className='grid w-full'>
                <Label className="text-sm	text-white pb-2">Выбрать категорию<span
            ...
            <div className='flex gap-4'>
              <div className='grid w-full'>
                <Label className="text-sm	text-white pb-2">Тайм код рекламы<span
                  className='text-red-500 ml-0.5'>*</span></Label>
                <Input
                  className={`border ${errors?.start_at ? 'border-red-500' : 'border-gray-300'}   transition-all duration-300 text-sm `}
                  type="time"
                  step="1"
                  inputMode="numeric"
                  {...register ('start_at')}
              ...
              <div className='grid w-full'           >
                  <Label className="text-sm	text-white pb-2">Начало<span
                    className='text-red-500 ml-0.5'>*</span></Label>
                  <Controller
              ...
              {role === 'admin' ? (
                <AlertDialog>
                  <AlertDialogTrigger asChild>
                    <Button
                      className="bg-red-300 hover:bg-red-500 border-2 border-red-500 w-full h-[44px] text-white rounded-lg mt-6"
                    >
                      Удалить
                    </Button>
                  </AlertDialogTrigger>
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      <AlertDialogTitle className='text-red-500'>Вы уверены, что хотите удалить?</AlertDialogTitle>
                      <AlertDialogDescription className='text-white'>
                        Это действие не может быть отменено. Это навсегда удалит видео и удалит ваши данные с наших серверов.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                      <AlertDialogCancel className='text-white'>Отмена</AlertDialogCancel>
                      <AlertDialogAction className='bg-red-300 hover:bg-red-500 border-2 border-red-500 ' onClick={handleRemoveInventory}>Удалить</AlertDialogAction>
                    </AlertDialogFooter>
                  </AlertDialogContent>
                </AlertDialog>
              ) : null}
