...
const TableHead = React.forwardRef(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-12 px-2 text-left align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0 first:rounded-tl-lg	 first:rounded-bl-lg	last:rounded-tr-lg	 last:rounded-br-lg',
      className,
    )}
    {...props}
  />
